  ...
  return (
    <nav className="bg-[#F4FCF9] p-2 shadow-md">
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-between">
        ...
        {/* Navigation Links */}
        <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-6 relative items-center mt-4 md:mt-0">
        ...
        {/* Search Bar */}
        <div className="relative w-full md:w-60 items-center flex flex-col mt-4 md:mt-0">
        ...
        {/* User Info */}
        <div className="relative items-center flex mt-4 md:mt-0">
          {user ? (
            <>
              <img
                src={user.pictureUrl}
